...
export class PortalEntityController extends Component {
    ...
    // Phase 1: Button / Lock / Humidifier controls
    async onPress() {
    ...
    // Phase 2: Number / Text / Select / Datetime controls
